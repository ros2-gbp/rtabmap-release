...
## rtabmap (jazzy) - 0.23.7-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy rtabmap` on `Sun, 21 Jun 2026 22:00:04 -0000`
...
## rtabmap (humble) - 0.23.7-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble rtabmap` on `Sun, 21 Jun 2026 21:49:25 -0000`
...
## rtabmap (rolling) - 0.22.1-1

The packages in the `rtabmap` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rtabmap --ros-distro rolling` on `Sat, 12 Jul 2025 19:00:52 -0000`
...
## rtabmap (kilted) - 0.22.1-1

The packages in the `rtabmap` repository were released into the `kilted` distro by running `/usr/bin/bloom-release rtabmap --ros-distro kilted` on `Sat, 12 Jul 2025 18:47:38 -0000`
...
## rtabmap (jazzy) - 0.22.1-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rtabmap --ros-distro jazzy` on `Sat, 12 Jul 2025 18:40:53 -0000`
...
## rtabmap (humble) - 0.22.1-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release rtabmap --ros-distro humble` on `Sat, 12 Jul 2025 18:29:10 -0000`
...
## rtabmap (kilted) - 0.22.0-1

The packages in the `rtabmap` repository were released into the `kilted` distro by running `/usr/bin/bloom-release rtabmap --ros-distro kilted -n` on `Tue, 10 Jun 2025 02:38:50 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/ros2-gbp/rtabmap-release.git
- rosdistro version: `0.21.6-2`
- old version: `0.21.6-2`
...
## rtabmap (jazzy) - 0.22.0-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rtabmap --ros-distro jazzy` on `Tue, 10 Jun 2025 02:34:59 -0000`
...
## rtabmap (humble) - 0.22.0-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release rtabmap --ros-distro humble` on `Tue, 10 Jun 2025 02:32:32 -0000`
...
The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rtabmap` on `Thu, 13 Feb 2025 03:49:42 -0000`
...
The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble rtabmap` on `Thu, 13 Feb 2025 03:35:18 -0000`
...
The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy rtabmap` on `Sun, 01 Dec 2024 19:04:16 -0000`
...
The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble rtabmap` on `Sun, 01 Dec 2024 19:01:00 -0000`
